...
// TODO(Kamil): desc
/// OKX DEX: Aggregation Router V2: swap
/// Example instruction: https://solscan.io/tx/4yyqE5cEW23N2U4HtovZMMgLJ3xisRQtwfHEGkcH44uR23cBH27HKfBKncvBdGs2HfivD3xskedFkrX6cVcEohEV
class SolanaSwapOkxInstruction extends ASolanaInstructionDecoded {
  ...
  const SolanaSwapOkxInstruction({
  ...
  factory SolanaSwapOkxInstruction.fromSerializedData(
    ...
    return SolanaSwapOkxInstruction(
      programId: programId,
      signer: signer,
      amountIn: amountIn,
