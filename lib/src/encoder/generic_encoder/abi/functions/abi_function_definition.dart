...
class AbiFunctionDefinition extends Equatable {
  ...
  Map<String, dynamic> decodeParameters(List<int> data) {
    ...
    for (AbiParamDefinition abiParamDefinition in inputs) {
      ...
      dynamic decoded = abiParamDefinition.type.decode(data, offset);
      decodedParams[abiParamDefinition.name] = decoded;
