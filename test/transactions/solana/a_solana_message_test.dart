...
void main() {
  group('Tests of ASolanaMessage.fromSerializedData()', () {
    test('Should [return SolanaLegacyMessage] when given legacy message', () {
      // Act
      ASolanaMessage actualSolanaLegacyMessage = ASolanaMessage.fromSerializedData(base64Decode(
    ...
    test('Should [throw Exception] when given data with transaction version 1 tag', () {
      ...
      // Assert
      expect(() => ASolanaMessage.fromSerializedData(Uint8List.fromList(actualSolanaV1Message)), throwsA(isA<Exception>()));
    });
  });
}
