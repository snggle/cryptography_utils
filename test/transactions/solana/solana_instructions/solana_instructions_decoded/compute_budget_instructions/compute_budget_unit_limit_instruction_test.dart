...
void main() {
  group('Tests of ComputeBudgetUnitLimitInstruction constructor', () {
    test('Should [return ComputeBudgetUnitLimitInstruction]', () {
      // Act
      ComputeBudgetUnitLimitInstruction actualComputeBudgetUnitLimitInstruction = const ComputeBudgetUnitLimitInstruction(
      ...
      int expectedUnitLimit = 123456;

      expect(actualComputeBudgetUnitLimitInstruction.programIdString, expectedProgramId);
      expect(actualComputeBudgetUnitLimitInstruction.unitLimitInt, expectedUnitLimit);
      expect(actualComputeBudgetUnitLimitInstruction.programId, expectedProgramId);
      expect(actualComputeBudgetUnitLimitInstruction.unitLimit, expectedUnitLimit);
    });
  });
  ...
  group('Tests of ComputeBudgetUnitLimitInstruction.fromSerializedData()', () {
    test('Should [return ComputeBudgetUnitLimitInstruction] from serialized data', () {
      ...
      SolanaInstructionRaw(programIdIndex: 3, accountIndices: <int>[], data: Uint8List.fromList(<int>[2, 239, 1, 0, 0]));
      String actualProgramId = Base58Codec.encode(actualAccountKeys[actualSolanaInstruction.programIdIndex]);

      // Act
      ComputeBudgetUnitLimitInstruction actualSolanaInstructionDecoded = ComputeBudgetUnitLimitInstruction.fromSerializedData(actualSolanaInstruction, actualProgramId);
