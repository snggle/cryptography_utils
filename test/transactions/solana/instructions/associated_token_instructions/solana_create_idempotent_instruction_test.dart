...
void main() {
  group('Tests of SwapInstruction.fromSerializedData()', () {
    test('Should [return SwapInstruction] from serialized data', () {
      // Act
      SolanaCreateIdempotentInstruction actualSolanaSwapInstruction = SolanaCreateIdempotentInstruction.fromSerializedData(
      ...
      // Assert
      SolanaCreateIdempotentInstruction expectedSolanaSwapInstruction = const SolanaCreateIdempotentInstruction(
