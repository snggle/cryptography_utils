...
void main() {
  group('Tests of ASolanaInstruction.decode()', () {
    ...
    test('Should [return SolanaSystemAssignInstruction] - testing _decodeSystemProgram() -> SolanaSystemAssignInstruction.fromSerializedData()', () {
      ...
      ASolanaInstructionDecoded actualSolanaSystemAssignInstruction = ASolanaInstructionDecoded.decode(
          SolanaCompiledInstruction(
            ...
            data: base64Decode(
                'AwAAAFGYCAVd43XhlRiSq7C4NB9zYy/yP5Zodzow9Mo0zXtcBwAAAAAAAABzdGFrZTowyAiZOwAAAADIAAAAAAAAAAah2BeRN1QqmDQ3vf4qerJVf1NcinhyK2ikncAAAAAA'),
          ),
          <SolanaPubKey>[
            SolanaPubKey.fromBytes(base64Decode('UZgIBV3jdeGVGJKrsLg0H3NjL/I/lmh3OjD0yjTNe1w=')),
      ...
      // Assert
      SolanaSystemAssignInstruction expectedSolanaSystemAssignInstruction = const SolanaSystemAssignInstruction(
        programId: '11111111111111111111111111111111',
    ...
    test('Should [return SolanaTokenTransferInstruction] - testing _decodeTokenProgram() -> SolanaTokenTransferInstruction.fromSerializedData()', () {
      ...
      // Assert
      SolanaTokenTransferInstruction expectedSolanaTokenTransferInstruction = const SolanaTokenTransferInstruction(
    ...
    test('Should [return SolanaUnknownInstruction] - testing ASolanaInstructionDecoded.decode() with unknown programId', () {
      ...
      // Assert
      SolanaUnknownInstruction expectedSolanaUnknownInstruction =
          const SolanaUnknownInstruction(programId: '6YawcNeZ74tRyCv4UfGydYMr7eho7vbUR6ScVffxKAb3');
