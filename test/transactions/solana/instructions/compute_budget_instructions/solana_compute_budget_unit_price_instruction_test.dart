...
void main() {
  group('Tests of ComputeBudgetUnitPriceInstruction.fromSerializedData()', () {
    test('Should [return ComputeBudgetUnitPriceInstruction] from serialized data', () {
      ...
      // Act
      SolanaComputeBudgetUnitPriceInstruction actualSolanaComputeBudgetUnitPriceInstruction = SolanaComputeBudgetUnitPriceInstruction.fromSerializedData(actualSolanaCompiledInstruction, actualProgramId);
    ...
    test('Should [throw RangeError] if there is incomplete data', () {
      ...
      SolanaCompiledInstruction(programIdIndex: 3, accounts: Uint8List(0), data: Uint8List.fromList(<int>[3, 0]));
      String actualProgramId = Base58Codec.encode(actualAccountKeys[actualSolanaInstruction.programIdIndex]);

      // Assert
      expect(() => SolanaComputeBudgetUnitPriceInstruction.fromSerializedData(actualSolanaInstruction, actualProgramId),
