...
void main() {
  group('Tests of AEthereumTransaction.fromSerializedData()', () {
    test('Should [return EthereumEIP1559Transaction] from given bytes', () {
      ...
      // Act
      AEthereumTransaction actualEthereumTransaction = AEthereumTransaction.fromSerializedData(TransactionType.tx, actualSerializedData);
    ...
    test('Should [return EthereumRawTransaction] from given bytes', () {
      ...
      // Act
      AEthereumTransaction actualEthereumTransaction = AEthereumTransaction.fromSerializedData(TransactionType.text, actualSerializedData);

      // Assert
      EthereumRawTransaction expectedEthereumTransaction = EthereumRawTransaction.fromSerializedData(
        base64Decode(
            ''),
      );
