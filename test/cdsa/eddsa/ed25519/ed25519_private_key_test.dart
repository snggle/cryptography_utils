...
void main() {
  ...
  group('Tests of ED25519PrivateKey.chainCode getter', () {
    test('Should [return chain code bytes] from ED25519PrivateKey', () {
      ...
      // Act
      Uint8List actualChainCode = actualED25519PrivateKey.chainCode;

      // Assert
      Uint8List expectedChainCode = base64Decode('bJz0NEJLEZUTTobbklJ8hYb9gCS+4J7UGPMtDyO+IDY=');
