...
void main() {
  group('Tests of SR25519PrivateKey.fromEDPrivateKey() constructor', () {
    test('Should [return SR25519PrivateKey] from given EDPrivateKey', () {
      ...
      // Act
      SR25519PrivateKey actualSR255PrivateKey = SR25519PrivateKey.fromEDPrivateKey(actualEDPrivateKey);
  ...
  group('Tests of SR25519PrivateKey.chainCode getter', () {
    test('Should [return chain code bytes] from SR25519PrivateKey', () {
      ...
      // Act
      Uint8List actualChainCode = actualSR25519PrivateKey.chainCode;

      // Assert
      Uint8List expectedChainCode = base64Decode('0PuuLRtj1ULEpcqIUms1XWTA/0LBtKPFeathnL61lOc=');
